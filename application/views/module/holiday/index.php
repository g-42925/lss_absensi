    ...
    <div class="card-header border-bottom">
      ...
      <div class="row mt-3 gap-1">
        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6 col-xs-5 input-group">
            ...
            <a href="<?= site_url('holiday/add') ?>" class="input-group-text btn btn-outline-primary">Tambah</a>
        </div>
      </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="w-s-n input-group">
              <a href="<?= site_url('holiday/edit/'.$row['id']) ?>" class="btn p-1">
                <i class="ti ti-edit"></i>
              </a>
              <a href="<?= site_url('holiday/delete/'.$row['id']) ?>" class="btn p-1">
