...
<div class="modal-body">
  <div class="text-center mb-4">
    <h3 class="role-title mb-2">Tambah Data</h3>
    <p class="text-muted">Set permissions</p>
  </div>
  <!-- Add role form -->
  <form class="row g-3" action="<?=base_url('company/permission/add_proses');?>" method="POST">
              ...
              <td class="text-nowrap text-center">
                <div class="d-flex">
                  <div class="form-check me-3 me-lg-5">
                    <input class="form-check-input" type="checkbox" name="tambah" id="userManagementRead" />
                    <label class="form-check-label" for="userManagementRead"> Tambah </label>
                  </div>
                  <div class="form-check me-3 me-lg-5">
                    <input class="form-check-input" type="checkbox" name="edit" id="userManagementWrite" />
                    <label class="form-check-label" for="userManagementWrite"> Edit </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="hapus" id="userManagementCreate" />
