  ...
  <div class="role-page">
    ...
    <div class="page-header">
      ...
      <p class="page-description">
        Buat jabatan baru dan tentukan hak akses yang dimilikinya.
      </p>
    ...
    <form
      action="<?= base_url('company/roles/add_proses'); ?>"
      method="POST"
    >
        ...
        <div class="section-heading">
          ...
          <div>
            ...
            <p class="section-description">
              Informasi dasar untuk jabatan yang akan dibuat.
            </p>
          </div>
...
<script>
  ...
  /*
   * Ambil checkbox dari satu group.
   */
