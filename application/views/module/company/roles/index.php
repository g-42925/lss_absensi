          ...
          <tr>
            ...
            <td align="right">
              <?php if($row['role_id']==1){ ?>
                Default
              <?php }else{ ?>
              <a href="<?=base_url('company/roles/edit/'.$row['role_id']);?>" class="btn p-1">
                <i class="ti ti-edit"></i>
              </a>
              <a href="#" class="btn p-1" data-bs-toggle="modal" data-bs-target="#delRow<?=$row['role_id'];?>">
                <i class="ti ti-trash"></i>
              </a>
              <!-- Konfirmasi Hapus -->
              <div class="modal fade" id="delRow<?=$row['role_id'];?>" tabindex="-1" aria-hidden="true">
                  ...
                  <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                      ...
                      <div class="col-12 text-center pt-3">
                        ...
                        <a href="<?=base_url('company/roles/hapus/'.$row['role_id']);?>" class="btn btn-danger">Ya, Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
