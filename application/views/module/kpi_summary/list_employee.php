...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    <div class="card-header border-bottom flex flex-row gap-3">
      <form method="get" action="<?= base_url('kpi_summary') ?>" class="flex flex-row w-full gap-3 m-0">
      ...
      <table class="table border-top" id="dataTable">
        ...
        <tbody>
          ...
          <tr class="text-center">
            ...
            <td>
              <a href="<?= base_url('kpi_summary/index/').$row['pegawai_id'] ?>" class="btn p-1 text-primary" title="Lihat Summary">
