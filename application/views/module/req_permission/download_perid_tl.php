...
$nama_file = 'izin-tugasluar-'.$datap['nama_pegawai'];
...
<table>
    <tr class="header">
        <td colspan="6" class="no-border"></td> <!-- Kolom Kosong -->
    </tr>
    <tr class="">
    ...
    <tr>
        <td class="no-border"></td> <!-- Kolom Kosong -->
        <td colspan="5" style="vertical-align: middle !important;"><h2>Form Tugas Luar</h2></td>
    </tr>
    <tr>
    ...
    <tr class="footer">
        <td class="no-border" colspan="6"></td> <!-- Kolom Kosong -->
    </tr>
    <tr class="footer">
        <td class="no-border"></td> <!-- Kolom Kosong -->
        ...
        <td colspan="5" class="no-border" style="text-align: right;">
            DiApproved Oleh,<br>
            HRD / Admin
        </td>
    </tr>
