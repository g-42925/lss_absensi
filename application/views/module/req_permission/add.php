...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card">
      <form class="card-body" action="<?=base_url('req_permission/add_proses');?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <select class="select2 form-select" name="kat" required="" onchange="selectKategori(this.value)">
              ...
              <option value="csh">Cuti Setengah Hari [CSH]</option>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <textarea type="text" class="form-control" name="catatanl" placeholder="..."></textarea>
          </div>
