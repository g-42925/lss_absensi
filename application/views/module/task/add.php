...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="card">
    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
      <h5 class="card-title mb-0">Tambahkan tugas</h5>
      <a href="<?= base_url('task/list'); ?>" class="btn btn-sm btn-label-secondary">
        <i class="ti ti-arrow-left me-1"></i> Kembali
      </a>
    </div>
    <div class="card">
      <form class="card-body" action="<?= base_url('task/add_proses'); ?>" method="POST" id="taskForm">
        <?= $this->session->flashdata('message'); ?>

        <div class="row g-3">

          <!-- Assigned To (AJAX Select2) -->
          ...
          <div class="col-xl-12 col-md-12">
            ...
            <textarea class="form-control" id="description" name="description" rows="4" placeholder="Detail pekerjaan yang harus diselesaikan..."></textarea>
          </div>
        ...
        <div class="pt-5 text-end">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="ti ti-device-floppy me-1"></i> Simpan Task
          </button>
        </div>
