  ...
  <div class="card">
    <div class="card-header border-bottom">
      ...
      <div class="text-start flex flex-row gap-3">
        <a href="<?=base_url('allowance/add?failed=false');?>" class="btn btn-secondary btn-primary btn-sm"><i class="ti ti-plus me-md-1"></i> Tambah Jenis Allowance</a>
      </div>
    </div>
