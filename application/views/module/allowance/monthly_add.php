...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card">
      <form class="card-body" action="<?=base_url('allowance/monthly_add_proses/');?>" method="POST">
        <?php if ($failed): ?>
        ...
        <div class="row g-3">
          ...
          <div class="flex flex-col gap-3">
            <label class="block text-gray-600 font-medium md:w-1/3">
              Forfeit on absence <span class="text-red-500">*</span>
            </label>
            <div class="mt-1 md:mt-0 md:w-2/3 space-x-6">
              <label class="inline-flex items-center">
                <input type="radio" name="foa" value="1" class="form-radio text-blue-600">
                <span class="ml-2 text-gray-700">Yes</span>
              </label>
              <label class="inline-flex items-center">
                <input checked type="radio" name="foa" value="0" class="form-radio text-blue-600">
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="mt-1 md:mt-0 md:w-2/3 space-x-6">
              <label class="inline-flex items-center">
                <input type="radio" name="fol" value="1" class="form-radio text-blue-600">
                <span class="ml-2 text-gray-700">Yes</span>
              </label>
              <label class="inline-flex items-center">
                <input checked type="radio" name="fol" value="0" class="form-radio text-blue-600">
                <span class="ml-2 text-gray-700">No</span>
              </label>
             </div>
          </div>
