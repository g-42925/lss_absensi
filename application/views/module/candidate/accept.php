      ...
      <form class="card-body" action="<?= base_url('candidate/accept_proccess/').$candidateId ?>" method="POST">
        ...
        <div class="row g-3">
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <input value="<?= $candidate['candidate_name'] ?>" type="text" class="form-control" name="nama" placeholder="..." required />
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <label class="form-label">Email<i class="text-danger">*</i></label>
            <input value="<?= $candidate['email'] ?>" type="email" class="form-control" name="email" placeholder="..." required />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            <label class="form-label">No WhatsApp</label>
            <input value="<?= $candidate['phone_number'] ?>" type="text" class="form-control" name="nom" placeholder="..." />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            <label class="form-label">No Induk Kependudukan</label>
            <input value="<?= $candidate['nik'] ?>" type="text" class="form-control" name="nik" />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
