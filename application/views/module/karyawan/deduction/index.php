  ...
  <div class="card">
    <div class="card-header border-bottom flex flex-col gap-3">
      <form method="get" action="<?= base_url().'karyawan/deduction/filter' ?>" class="flex flex-row w-full gap-3">
        ...
        <input list="employees" name="keyword" onKeyUp="onKeyChg(this)" id="target2" placeholder="card id or name" type="text" class="p-3 border-2 border-black rounded-md" placeholder=""/>
