            ...
            <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6 md:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="mt-1 md:mt-0 md:w-2/3">
                            <input type="time" value="<?= $current['halfLeaveLimit'] ?>" name="halfLeaveLimit" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    <!-- Field: Late Penalty -->
                    <div class="flex flex-col md:flex-row md:items-center">
