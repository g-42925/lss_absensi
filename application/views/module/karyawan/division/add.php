  ...
  <div class="row justify-content-center">
    <div class="col-12 col-xl-10">
      ...
      <div class="card border-0 shadow-sm overflow-hidden">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div class="min-w-0">
              ...
              <div class="text-muted small">
                Konfigurasikan pola kerja, absensi, dan kebijakan divisi.
              </div>
        ...
        ====================================================== -->
        <form
          action="<?= base_url('karyawan/division/add_proses') ?>"
          method="post"
        >
          ...
          <div class="card-body px-4 px-md-5 py-4 py-md-5">
            ...
            <section class="config-section">
              ...
              <div class="section-content">
                ...
                <div class="form-text">
                  Gunakan nama yang mudah dikenali oleh karyawan.
                </div>
                    ...
                    <div class="choice-grid">
                      ...
                      >
                        ...
                        <span>
                          ...
                          <small>Sistem berbasis shift</small>
                        </span>
              ...
              <div class="section-content">
                ...
                <div class="row g-4">
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="form-text">
                      Batas toleransi sebelum absensi masuk dibatasi.
                    </div>
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="form-text">
                      Batas toleransi untuk absensi pulang.
                    </div>
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="simple-setting">
                      ...
                      <div>
                        ...
                        <div class="text-muted small">
                          Izinkan absensi dari luar lokasi kantor.
                        </div>
                      </div>
                  ...
                  <div class="col-12 col-md-6">
                    ...
                    <div class="simple-setting">
                      ...
                      <div>
                        ...
                        <div class="text-muted small">
                          Izinkan absensi pulang di luar kantor.
                        </div>
                      </div>
            ...
            <section class="config-section">
              ...
              <div class="section-heading">
                ...
                <div>
                  ...
                  <p class="section-description">
                    Atur konsekuensi keterlambatan dan kompensasi lembur.
                  </p>
                </div>
                ...
                <div class="setting-row">
                  ...
                  <div class="setting-info">
                    ...
                    <div>
                      ...
                      <div class="text-muted small">
                        Potongan ketika karyawan melewati batas waktu masuk.
                      </div>
                    </div>
                  ...
                  <div class="setting-control">
                    ...
                    <div
                      id="latePenaltyNominal"
                      class="dynamic-control d-none"
                    >
                ...
                <div class="setting-row">
                  ...
                  <div class="setting-info">
                    ...
                    <div>
                      ...
                      <div class="text-muted small">
                        Tentukan apakah lupa absen pulang dikenakan penalty.
                      </div>
                    </div>
                ...
                <div class="setting-row">
                  ...
                  <div class="setting-info">
                    ...
                    <div>
                      ...
                      <div class="text-muted small">
                        Dasar nominal yang digunakan untuk perhitungan lembur.
                      </div>
                    </div>
            ...
            <section class="config-section mb-0">
              ...
              <div class="section-heading">
                ...
                <div>
                  ...
                  <p class="section-description">
                    Atur potongan ketika karyawan melewati batas waktu istirahat.
                  </p>
                </div>
              ...
              <div class="complex-setting">
                ...
                <div class="complex-setting-main">
                  ...
                  <div>
                    ...
                    <div class="text-muted small">
                      Tentukan apakah keterlambatan setelah istirahat
                      dikenakan potongan.
                    </div>
                ...
                <div class="complex-setting-controls">
                  ...
                  >
                    ...
                    <!-- Value -->
                    <div id="afterBreakLatePenaltyValue">
...
function showWeeklyList() {
  ...
  const shift = document.getElementById('shiftList');

  weekly.classList.remove('d-none');
  shift.classList.add('d-none');

  document.getElementById('weeklyPattern').required = true;
  document.getElementById('shiftPattern').required = false;
...
function showShiftList() {
  ...
  shift.classList.remove('d-none');

  document.getElementById('weeklyPattern').required = false;
  document.getElementById('shiftPattern').required = true;
  document.getElementById('weeklyPattern').value = '';
...
function toggleLatePenalty() {
  ...
  const enabled =
    document.querySelector(
      'input[name="latePenalty"]:checked'
    )?.value === '1';

  const container =
    document.getElementById('latePenaltyNominal');

  const input =
    document.getElementById('penaltyNominal');
...
function toggleAlphaPenalty() {
  ...
  const fields =
    document.getElementById('alphaPenaltyFields');

  const warning =
    document.getElementById('alphaOffdaysWarning');
