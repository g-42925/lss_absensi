...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    ...
    <div class="card">
      <form class="card-body" action="<?= base_url('karyawan/premutation/next_proccess/').$e['pegawai_id'] ?>" method="POST">
        <div class="row g-3">
          ...
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <input value="<?= $e['nama_pegawai']  ?>" type="text" class="form-control" name="nama" placeholder="..." readonly />
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <label class="form-label">Email<i class="text-danger">*</i></label>
            <input value="<?= $e['email_pegawai'] ?>" type="email" class="form-control" name="email" placeholder="..." readonly />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            <label class="form-label">No WhatsApp</label>
            <input value="<?= $e['nomor_pegawai'] ?>" type="text" class="form-control" name="nom" placeholder="..." readonly />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
            <label class="form-label">No Induk Kependudukan</label>
            <input value="<?= $e['nik'] ?>" type="text" class="form-control" name="nik" />
          </div>
          <div class="col-xl-6 col-md-6 col-sm-6 col-xs-6">
