...
class Holiday extends CI_Controller {
    ...
    public function index() {
        ...
        $data['offdays'] = $this->db->query("select * from global_holidays where company_id=$companyId order by tanggal desc")->result_array();

        $this->load->view('templates/header',$data);
        $this->load->view('templates/sidemenu',$data);
        $this->load->view('templates/sidenav');
        $this->load->view('module/holiday/index',$data);
     ...
     public function add(){
        ...
        $this->load->view('templates/sidemenu',$data);
        $this->load->view('templates/sidenav');
        $this->load->view('module/holiday/add',$data);
        $this->load->view('templates/footer');
        $this->load->view('templates/fscript-html-end');       
    }
    ...
    public function add_proses(){
        ...
        $this->db->insert('global_holidays', [
